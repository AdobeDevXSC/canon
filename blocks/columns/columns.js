...
export default function decorate(block) {
  ...
  console.log('5 bkgdColorAttr in columns row UE: ', ueBkgdColorAttr);

  const ueTextColorAttr = columnsChild?.getAttribute('data-text-color');
  console.log('5 textColorAttr in columns row UE: ', ueTextColorAttr);
  ...
  console.log('5 block.style.backgroundColor: ', block.style.backgroundColor);
